...
const DetailsAnimalScreen = ({ navigation, nextRoute }) => {
    ...
    const handleCreateAnimal = (race, produtiveSituation, age)=>{
        const nextPage = navigation.navigate(state.situation == "Apto para abate" ? nextRoute = "SuccessAnimal" : nextRoute = "ProblemAnimal")
    
        createAnimal(state, nextPage, produtiveSituation, race, age)
    }
            ...
            <ScrollView centerContent={true} contentContainerStyle={styles.contentContainerScrollView}>
                <Formik
                    ...
                    onSubmit={values => {
                        ...
                        handleCreateAnimal(values.reproductiveSituation, values.animalRace, values.age);
