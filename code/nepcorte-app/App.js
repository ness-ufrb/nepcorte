...
// Context Providers
import { AuthProvider } from './src/context/UserContext/AuthContext';
import { Provider as SortingProvider } from './src/context/SortingContext/Context'
      ...
      <Provider store={store}>
        <NavigationContainer>
          ...
          >
            ...
            />
            <Tab.Screen name="Conta" component={FakeLogin}
              options={{
                tabBarIcon: ({ focused }) => (
